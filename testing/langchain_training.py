#%%
from dotenv import find_dotenv, load_dotenv  # used for loading env variables from .env
import pandas
import nest_asyncio # ?
import os  # enables interaction with local file system
# from langchain_community.chat_models import
from langsmith import Client # create a langSMITH client (not langCHAIN)
from langchain_openai import ChatOpenAI  # create an OpenAI client
